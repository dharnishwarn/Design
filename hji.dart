            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Icon(Icons.app_registration, size: 28, color: Colors.blue),
                    Icon(Icons.notifications, size: 28, color: Colors.blue),
                  ],
                ),
                SizedBox(height: 10),
                Text(
                ...
                GridView.count(
                  ...
                  crossAxisSpacing: 10,
                  children: [
                    _buildGridItem(Icons.category, "Category", Colors.red),
